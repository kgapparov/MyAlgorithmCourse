...
public class Graph {
	...
	public boolean pathExists(Vertex u, Vertex v) {
		if (adjList.containsKey(u)) {
			return adjList.get(v).contains(v);
		}
		return false;
	}
	...
	public boolean isConnected() {
		...
		bfs.start();
		return bfs.getComponentCount() == 1;
	}
	
	public int numConnectedComponents() {
		BreadthFirstSearch bfs = new BreadthFirstSearch(this);
		bfs.start();
		return bfs.getComponentCount();
	}
	...
	public boolean hasCycle() {
		BreadthFirstSearch bfs = new BreadthFirstSearch(this);
		bfs.start();
		return bfs.getEdgeCount() < getEdgeCount();
	}
	...
	public static void main(String[] args) {
		...
		BreadthFirstSearch bfs = new BFS(g);
		bfs.start();
		System.out.println(bfs.getComponentCount());
